...
var _HTTPRequestException = _interopRequireDefault(require("./Exceptions/HTTPRequestException"));
var _HTTPMappingResponse = _interopRequireDefault(require("./HTTPMappingResponse"));
var _HTTPRequestCollection = _interopRequireDefault(require("./Collections/HTTPRequestCollection"));
var _HTTPResponse = _interopRequireDefault(require("./HTTPResponse"));
var _FormDataSerializer = _interopRequireDefault(require("../Supports/FormDataSerializer"));
...
var HTTPRequest = /*#__PURE__*/function () {
  function HTTPRequest() {
    ...
    /**
     * Dominio origem de requisicoes.
     *
     * @private
     *
     * @type {String}
     */
    _defineProperty(this, "base_uri", document.location.origin);
    /**
     ...
     */
    _defineProperty(this, "mapping_response", new _HTTPMappingResponse["default"]());
    /**
     ...
     */
    _defineProperty(this, "formdata_serializer", new _FormDataSerializer["default"]());
  }
  _createClass(HTTPRequest, [{
    ...
    key: "request",
    value: function () {
      var _request = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(endpoint) {
        var data,
          options,
          url_request,
          response_item,
        ...
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              ...
              this.handleOptionsRequest(options);
            ...
            case 7:
              url_request = this.createURLRequest(endpoint);
              this.handleBodyRequest(url_request, data, options);
              _context3.prev = 9;
              response_item = this.requests.setCurrentRequest(options.request_id);
              _context3.next = 13;
              return fetch(url_request, options);
            case 13:
              request_fetch = _context3.sent;
            ...
            case 16:
              _context3.next = 18;
              return this.mapping_response.parseResponse(response_item, request_fetch);
            case 18:
              return _context3.abrupt("return", response_item);
            case 21:
              _context3.prev = 21;
              _context3.t0 = _context3["catch"](9);
              throw new _HTTPRequestException["default"](_context3.t0.message);
            case 24:
              _context3.prev = 24;
    ...
    key: "createURLRequest",
    value: function createURLRequest(endpoint) {
    ...
    key: "handleOptionsRequest",
    value: function handleOptionsRequest(options) {
    ...
    key: "handleBodyRequest",
    value: function handleBodyRequest(url_request, data, options) {
      if (options.method == 'GET') {
        url_request.search = new URLSearchParams(data).toString();
        return;
      }
      if (!(data instanceof FormData)) {
        options.body = this.formdata_serializer.serialize(data);
        return;
      }
      options.body = data;
    }
...
function requestPost(_x4) {
  return _requestPost.apply(this, arguments);
}
function _requestPost() {
  _requestPost = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(endpoint) {
    var data,
      options,
      _args4 = arguments;
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          ...
          _context4.next = 4;
          return new HTTPRequest().post(endpoint, data, options);
        case 4:
...
function requestGet(_x5) {
  return _requestGet.apply(this, arguments);
}
function _requestGet() {
  _requestGet = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(endpoint) {
    var data,
      options,
      _args5 = arguments;
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          ...
          _context5.next = 4;
          return new HTTPRequest().get(endpoint, data, options);
        case 4:
