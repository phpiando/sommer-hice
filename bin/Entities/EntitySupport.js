...
/**
 * @description EntitySupport class to serialize data
 * in JSON format
 * @class
 * @license public
 ...
 * @since 1.0.0 
 */
var EntitySupport = /*#__PURE__*/function () {
  function EntitySupport(entity) {
    var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
    _classCallCheck(this, EntitySupport);
    /**
     * Entity instance
     * @private
     * @type {Entity}
    ...
    if (!(entity instanceof _Entity["default"])) {
      console.error('EntitySupport: Entity must be an instance of Entity');
    }
