 ...
 */
var CollectionIndexed = /*#__PURE__*/function (_Collection) {
  _inherits(CollectionIndexed, _Collection);
  var _super = _createSuper(CollectionIndexed);
  function CollectionIndexed(index_id) {
     ...
     * @type {Number}
     */
    _defineProperty(_assertThisInitialized(_this), "_index_id", void 0);
   ...
   * @returns {Boolean}
   */
  _createClass(CollectionIndexed, [{
    key: "set",
    value: function set(item) {
      ...
      return _get(_getPrototypeOf(CollectionIndexed.prototype), "set", this).call(this, id, item, at_beginning);
    }
    ...
    key: "setFromArray",
    value: function () {
      var _setFromArray = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(items) {
...
exports["default"] = CollectionIndexed;