 ...
 */
var StateHTTP = exports["default"] = /*#__PURE__*/function (_StateBase) {
  function StateHTTP() {
    var _this;
    ...
    _this = _callSuper(this, StateHTTP, [].concat(args));
    /**
     ...
     * @type {Object}
     */
    _defineProperty(_this, "_callbacks", {});
    return _this;
  }
  _inherits(StateHTTP, _StateBase);
  return _createClass(StateHTTP, [{
    key: "dispatch",
    value:
    /**
