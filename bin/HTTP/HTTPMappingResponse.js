...
var HTTPMappingResponse = /*#__PURE__*/function () {
  function HTTPMappingResponse() {
    _classCallCheck(this, HTTPMappingResponse);
  }
  _createClass(HTTPMappingResponse, [{
    key: "parseResponse",
    value:
    /**
     ...
     */
    function () {
      var _parseResponse = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(response_item, request_response) {
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              return _context.abrupt("return", response_item);
            case 7:
            case "end":
    ...
    key: "parseXHRResponse",
    value: function parseXHRResponse(response_text) {
      return JSON.parse(response_text, function (key, value) {
  ...
  return HTTPMappingResponse;
}();
exports["default"] = HTTPMappingResponse;