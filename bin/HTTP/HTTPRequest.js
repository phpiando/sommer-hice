...
var HTTPRequest = exports["default"] = /*#__PURE__*/function () {
  ...
  return _createClass(HTTPRequest, [{
      ...
      var _request = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(endpoint) {
        ...
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            ...
            case 6:
              response_request = _context4.sent;
              if (!response_request) {
                _context4.next = 9;
                break;
              }
              return _context4.abrupt("return", response_request);
            case 9:
    ...
    key: "_existsRequest",
    value: (function () {
      var _existsRequest2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(options) {
        var response;
